...
#define DEF_FREQUENCY_UP_THRESHOLD		(85)	//default 70
#define DEF_FREQUENCY_UP_THRESHOLD_HOTPLUG	(85)	// default 68 ZZ: default for hotplug up threshold for all cpus (cpu0 stays allways on)
#define DEF_FREQUENCY_DOWN_THRESHOLD		(80)	//default 52
#define DEF_FREQUENCY_DOWN_THRESHOLD_HOTPLUG	(75)	//default 55 ZZ: default for hotplug down threshold for all cpus (cpu0 stays allways on)
...
#define MAX_CORES		(2) //original 4 (GS2 son 2 cores)
...
#define DEF_UP_THRESHOLD_SLEEP			(95)	// 90 original ZZ: default for tuneable up_threshold_sleep
#define DEF_DOWN_THRESHOLD_SLEEP		(85)	// Z44 original Z: default for tuneable down_threshold_sleep
...
#define DEF_HOTPLUG_SLEEP			(1)	// default 0 ZZ: default for tuneable hotplug_sleep 
...
#define DEF_FREQ_LIMIT				(1200000) //default 0, ZZ: default for tuneable freq_limit
#define DEF_FREQ_LIMIT_SLEEP			(500000)  //default 0, ZZ: default for tuneable freq_limit_sleep
