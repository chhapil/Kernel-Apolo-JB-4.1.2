...
#define DEF_FREQUENCY_UP_THRESHOLD		  (85) //***** Apolo, Original 70 ******************
#define DEF_FREQUENCY_UP_THRESHOLD_HOTPLUG	  (85)	// ***** Apolo, Original 68 ******************
#define DEF_FREQUENCY_UP_THRESHOLD_HOTPLUG_FREQ   (0) 	// Yank: default for hotplug up threshold frequency for all cpus (0 = disabled)
#define DEF_FREQUENCY_DOWN_THRESHOLD		  (80) //***** Apolo, Original 52 ******************
#define DEF_FREQUENCY_DOWN_THRESHOLD_HOTPLUG	  (60)	//***** Apolo, Original 55 ******************
...
#define MAX_CORES		(2) //***** Apolo, Original 4 GS2 son 2 cores ******************
...
#define DEF_UP_THRESHOLD_SLEEP			(95)	//***** Apolo, Original 90 ******************
#define DEF_DOWN_THRESHOLD_SLEEP		(85)	//***** Apolo, Original 44 ******************
...
#define DEF_FREQ_LIMIT_SLEEP			(500000)	//***** Apolo, Original 0 ******************
